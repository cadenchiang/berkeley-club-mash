/**
 * Vercel serverless function to proxy comment votes to Supabase Edge Function.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch(`${supabaseUrl}/functions/v1/vote-comment`, {
      method: 'POST',
      headers: {
    ...
    console.error('Vote comment proxy error:', error);
