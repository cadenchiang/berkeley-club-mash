-- Add GLOBAL rate limit to stop bot creating new sessions for each vote
...
BEGIN
  ...
  -- GLOBAL RATE LIMIT: Max 60 votes total per minute (stops bot spam)
...
-- Reset Blockchain AGAIN
UPDATE clubs SET elo_rating = 1500, wins = 50, total_votes = 100
