-- Remove 2-second cooldown between votes
...
BEGIN
  ...
  -- PROTECTION 1: Rate limiting by session: max 200 votes per session per hour
  ...
  -- PROTECTION 2: Rate limiting by fingerprint: max 250 votes per fingerprint per hour
  ...
  -- PROTECTION 3: Same-club voting limit (max 3 votes for same club per hour)
  ...
  -- PROTECTION 4: Global club throttle (max 30 wins per club per minute)
  ...
  -- PROTECTION 5: Enforce rating bounds (100-3000)
